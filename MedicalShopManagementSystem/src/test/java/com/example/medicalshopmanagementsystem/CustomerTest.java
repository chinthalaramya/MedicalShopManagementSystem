	...
	@Test
	   @Order(1)
		public void testCreateCustomer() {
		  ...
		  cust.setCustomerId((long) 1102);
		  cust.setCustomerName("Shashi");
		  cust.setCustomerPhoneNo("8907865874");
		  cust.setCustomerAddress("Hyderbad");
		  
		  cRepo.save(cust);
		  
		  assertNotNull(cRepo.findById((long) 1102).get()); 
	   ...
	   public void testUpdateCustomer() {
		 ...
		 cRepo.save(c);
		 assertNotEquals("vinay",cRepo.findById((long) 1001).get().getCustomerName());
		   
	   }
	   @Test
	   @Order(5)
	   public void testDeleteCustomer() {
		   cRepo.deleteById((long) 1101);
		   assertThat(cRepo.existsById((long) 1101)).isFalse();
	   }
